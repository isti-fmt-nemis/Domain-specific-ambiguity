...
if __name__ == '__main__':
    ...
    generate_CSV_from_index(CS_EEN_top_f01, domain_list_CS_EEN, SENT_NUM, './CSV-AMT-Index/CS_EEN_topf01.csv') 
    generate_CSV_from_index(CS_EEN_step_f01, domain_list_CS_EEN, SENT_NUM, './CSV-AMT-Index/CS_EEN_stepf01.csv') 
    generate_CSV_from_index(CS_EEN_top_f03, domain_list_CS_EEN, SENT_NUM, './CSV-AMT-Index/CS_EEN_topf03.csv') 
    generate_CSV_from_index(CS_EEN_step_f03, domain_list_CS_EEN, SENT_NUM, './CSV-AMT-Index/CS_EEN_stepf03.csv')
